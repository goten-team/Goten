...
_aes_key_expand_128(__m128i round_keys[AES_STREAM_ROUNDS + 1], __m128i t1)
{
    ...
    // uint8_t array[16] = {};
    // t1 = _mm_load_si128( (__m128i*) &array[0] );
                ...
                const unsigned char seed[AES_STREAM_SEEDBYTES])
{
    ...
    // CRYPTO_ALIGN(16) unsigned char seed[AES_STREAM_SEEDBYTES];
    // memcpy(&seed, &unaligned_seed, AES_STREAM_SEEDBYTES * sizeof(unsigned char));
